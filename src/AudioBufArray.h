...
#if ! defined (AudioBufArray_HEADER_INCLUDED)
#define	AudioBufArray_HEADER_INCLUDED
...
typedef	DynArray <AudioBuf>	AudioBufArray;



#endif	// AudioBufArray_HEADER_INCLUDED
